...
def pipe_mesh(direc,length, thickness, radial, section = 0, r = 1.5, quad = 1, reduced = 0):    
...
#    mesh = open(direc+"Mesh_" + str(length) + "x" + str(thickness) + "x" + str(n) + "_"
#    + elestr +interstr +".inp","w")
    mesh = open(direc+"Mesh.inp","w")
